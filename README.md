...
| **🎨 Frontend** | HTML5 · CSS3 · React · Next.js · Tailwind CSS · Three.js · Framer Motion · GSAP · shadcn/ui · Vite |
| **⚙️ Backend** | Node.js · Express.js · Socket.IO · REST APIs · JWT Authentication · Nodemailer |
| **🗄️ Databases & ORM** | MongoDB · PostgreSQL · MySQL · Prisma · Supabase |
| **☁️ Cloud & DevOps** | Docker · AWS EC2 · GitHub Actions · Cloudinary · Render · Vercel |
| **🛠️ Developer Tools** | Git · GitHub · VS Code · IntelliJ IDEA · Postman · MongoDB Compass · Figma |
